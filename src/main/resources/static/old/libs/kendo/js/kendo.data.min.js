...
},N(!0,E.data,{readers:{json:Pt},Query:a,DataSource:Rt,HierarchicalDataSource:jt,Node:Gt,ObservableObject:qt,ObservableArray:wt,LocalTransport:zt,RemoteTransport:Nt,Cache:Tt,DataReader:Pt,Model:bt})})(window.kendo.jQuery);