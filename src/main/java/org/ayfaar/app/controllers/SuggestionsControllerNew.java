...
public class SuggestionsControllerNew {
    ...
    private List<Map.Entry<String, String>> getSuggestions(Queue<String> queriesQueue, Suggestions item ) {
        ...
        Collections.sort(suggestions, new Comparator<Map.Entry<String, String>>() {

            @Override
            public int compare(Map.Entry e1, Map.Entry e2) {
                return Integer.valueOf(e1.getValue().toString().length()).compareTo(e2.getValue().toString().length());
            }
