...
angular.module("live-search", ["ng"])
 .directive("liveSearch", ["$compile", "$timeout", "$rootScope", function ($compile, $timeout) {
    return {
        restrict: 'E',
        replace: true,
        scope: {
        ...
        template: "<input type='text' class='live-search' />",
        link: function (scope, element, attrs, controller) {
            ...
            scope.$watch("selectedIndex", function(newValue, oldValue) {
                ...
                if(item) {
                    ...
                    if (scope.selected) {
                        scope.selected.call(scope, item)
                    }
                }
            });
            ...
            element[0].onkeyup = function (e) {
                ...
                timeout = $timeout(function () {
                    var results = [];
                    var promise = scope.fetchData.call(null, { query: search_string });
