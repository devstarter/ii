...
class TermsMarkerIntegrationTest : IntegrationTest() {
    @Inject
    lateinit var termsMarker: TermsMarker
    ...
    fun test() {
        ...
        val actual = termsMarker.mark(text)
        ...
        val actual2 = termsMarker.mark(text2)
        ...
        val actual3 = termsMarker.mark(text3)
        ...
        val actual4 = termsMarker.mark(text4)
        ...
        val actual5 = termsMarker.mark(text5)
        ...
        val actual6 = termsMarker.mark(text6)
        ...
        val actual7 = termsMarker.mark(text7)
        ...
        val actual8 = termsMarker.mark(text8)
    ...
    @Test
    fun testItems() {
        assertEquals("<uri>1.0001</uri>", termsMarker.mark("1.0001", true))
    }
}
