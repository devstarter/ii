...
/**
 * A {@code RestErrorResolver} resolves an exception and produces a {@link BusinessError} instance that can be used
...
public interface RestErrorResolver {
    ...
    /**
     * Returns a {@code BusinessError} instance to render as the response body based on the given exception.
     *
     ...
     * @return a resolved {@code BusinessError} instance to render as the response body or <code>null</code> for default
     *         processing
     */
    BusinessError resolveError(ServletWebRequest request, Object handler, Exception ex);
}
